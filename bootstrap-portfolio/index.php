...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,
statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyDNPIQSV2_lgxRcFKlIQyiODZKvkTF5ET4');

$profileYoutubePic = $result['items'][0]['snippet']['thumbnails']['medium']['url'];
$channelName = $result['items'][0]['snippet']['title'];
$subscriber = $result['items'][0]['statistics']['subscriberCount'];
//video terbaru
$video = get_CURL('https://www.googleapis.com/youtube/v3/search?
key=AIzaSyDNPIQSV2_lgxRcFKlIQyiODZKvkTF5ET4&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResult=1&order=date&part=snippet');
